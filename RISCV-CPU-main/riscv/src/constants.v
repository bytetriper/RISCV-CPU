...
`define AUIPC 17'b00100110000000000
`define SB 17'b01000110000000000
`define SH 17'b01000110010000000
`define SW 17'b01000110100000000
`define ADD 17'b01000110000000000
`define SUB 17'b01000110000100000
`define SLL 17'b01000110010000000
`define SLT 17'b01000110100000000
`define SLTU 17'b01000110110000000
`define XOR 17'b01000111000000000
`define SRL 17'b01000111010000000
`define SRA 17'b01000111010100000
`define OR 17'b01000111100000000
`define AND 17'b01000111110000000
